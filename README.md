...
| --- | ---: | --- | ---: |
| Python | 80.78% | TypeScript | 13.20% |
| Go | 1.46% | TeX | 1.44% |
| JavaScript | 0.62% | HTML | 0.57% |
| BibTeX Style | 0.50% | CSS | 0.42% |
| Shell | 0.42% | MDX | 0.20% |
| C++ | 0.15% | PowerShell | 0.12% |
| Makefile | 0.09% | Dockerfile | 0.03% |
| Batchfile | 0.01% | Ruby | 0.00% |
<!-- END_LANGUAGES -->
